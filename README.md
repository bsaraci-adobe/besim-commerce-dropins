...
- Preview: https://main--besim-commerce-dropins--bsaraci-adobe.hlx.page/
- Live: https://main--besim-commerce-dropins--bsaraci-adobe.hlx.live/
...
1. Open the `besim-commerce-dropins` directory in your favorite IDE and start coding :)
